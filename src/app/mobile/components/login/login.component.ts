...
export class LoginComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  ngOnInit() {
    ...
    // this._account_service.data('', '', '', 'check', '').subscribe(res => {
    //   console.log(res);
    // });
 ...
 ngOnChanges() {
  ...
  enterMode(name) {
    if (name === 'log in') {
      this.mode = 'login';
      this.log_in = true; this.register = false;
      ...
      // }
      this.mode = 'register';
      this.log_in = false; this.register = true;
  ...
  get_users() {
    ...
    if (this.mode === 'register'  ) {
      ...
      //   recoverPhone = (<HTMLInputElement>document.getElementById('recoverPhone')).value;
      //   recoverMethod = 'phone';
      //   if (recoverPhone === '') {
      //     alert('Поле телефона для восстановления не заполнено');
      //   } else {
      //     this._account_service.data(this.login, this.pass, recoverPhone, this.mode, recoverMethod).subscribe(res => {
      //       console.log(res);
      //       for (let str of Object.values(res)) {
      //         this.result += str.toString();
      //         document.getElementById('res1').innerHTML = this.result;
      ...
      console.log('work ' + this.phone + " " + this.login);
      recoverMethod = 'phone';
    ...
    //   if (this.emailPass) {
    //     this.login = (<HTMLInputElement>document.getElementById('recoverEmail')).value;
    //     recoverMethod = 'login';
    //   } else  if (this.phonePass) {
    //     this.phone = (<HTMLInputElement>document.getElementById('recoverPhone')).value;
    //     recoverMethod = 'phone';
    //   }
    //   let access_code1 = (<HTMLInputElement>document.getElementById('recoverKey')).value;
    //     this._account_service.data(this.login, access_code1, this.phone, this.mode, recoverMethod).subscribe(res => {
    //       console.log(res);
    //       for (let str of Object.values(res)) {
    //         //  console.log(str);
    //         this.result += str.toString();
